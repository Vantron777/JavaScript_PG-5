import{i as O,a as A}from"./vendor-8cce9181.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const v={openBurgerBtn:document.querySelector(".burger-menu"),closeBurgerBtn:document.querySelector(".mobile-menu__button"),burger:document.querySelector(".mobile-menu-container")};v.openBurgerBtn.addEventListener("click",M);v.closeBurgerBtn.addEventListener("click",M);function M(){v.burger.classList.toggle("is-hidden")}function u(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e),document.querySelectorAll('.common-toggle input[type="checkbox"]').forEach(function(t){e==="dark"?t.checked=!0:t.checked=!1})}const I=localStorage.getItem("theme");u(I||"light");const oe=document.querySelectorAll('.common-toggle input[type="checkbox"]');oe.forEach(function(e){e.addEventListener("change",function(o){o.target.checked?u("dark"):u("light")},!1)});const q=document.querySelector('.toggle-theme input[type="checkbox'),k=localStorage.getItem("theme");k&&(document.documentElement.setAttribute("data-theme",k),k==="dark"&&(q.checked=!0));q.addEventListener("change",se,!1);function se(e){e.target.checked?(document.documentElement.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark")):(document.documentElement.setAttribute("data-theme","light"),localStorage.setItem("theme","light"))}function N(e){return e.map(t=>{const{_id:s,book_image:n,title:i,author:l}=t;return`<li class="books-box-itm" id="${s}">
      <div class="books-box-wrap">
            ...
            </li>`}).join("")}const ne=(e,o)=>{if(!e||e.length===0){V("Sorry, books not found");return}else return`<h2 class="books-box-title">Best Sellers <span class="books-title-span"> Books</span></h2>${e.map(s=>{const n=s.list_name,i=N(s.books.slice(0,o));return`<div class="books-box-holder">
 ...
 <div class="books-category-box">
   <ul class="books-category-list">${t}</ul>
      ...
      <div class="modal-content">
        ...
        <svg class="close-btn-icon" width="16" height="16">
          <use href="${F}#icon-x-close-black"></use>
  ...
  `}function ue(e){var t;const o={amazon:"Amazon",appleBooks:"Apple Books"};for(const[s,n]of Object.entries(o))o[s]=(t=e.find(i=>i.name===n))==null?void 0:t.url;return`
    <ul class="marketplace-list">
        ...
        ${o.appleBooks?`<li class="marketplace-list-item">
          ...
          </ul>`}const Q="addBook";let r;async function pe(e){const o=e.target.closest("button");try{if(o.classList.contains("modal-button-shopping-list")){r=JSON.parse(localStorage.getItem(Q))||[];const t=await H(o.dataset.id),s=r.some(n=>n._id===t._id);console.log(r,s),s?r=r.filter(n=>n._id!==t._id):r.push(t),localStorage.setItem(Q,JSON.stringify(r))}}catch(t){console.log(t.message)}}const Ae=document.querySelector(".modal-js"),E=document.querySelector(".backdrop");let b,y;E.addEventListener("click",he);async function S(e){console.log("Received bookId:",e);const o=await H(e),t=ge(o);Ae.innerHTML=t,me(),b=document.querySelector(".modal-button-shopping-list"),y=document.querySelector(".modal-close-btn-js"),b.addEventListener("click",K),y.addEventListener("click",j),console.log(t)}function me(){E.classList.remove("remove-modal"),document.body.classList.add("show-modal"),window.addEventListener("keydown",w)}function B(){E.classList.add("remove-modal"),document.body.classList.remove("show-modal"),window.removeEventListener("keydown",w),window.removeEventListener("keydown",w),b.removeEventListener("click",K),y.removeEventListener("click",j)}function K(e){const o="addBook";pe(e);const t=e.target.closest("button");if(!t.classList.contains("modal-button-shopping-list"))return;(JSON.parse(localStorage.getItem(o))||[]).some(i=>i._id===t.dataset.id)?t.textContent="Add to shopping list":t.textContent="Remove from shopping list",t.nextElementSibling.classList.toggle("hidden")}function j(e){B()}function he(e){e.currentTarget===e.target&&B()}function w(e){console.log(e),e.key==="Escape"&&B()}document.addEventListener("DOMContentLoaded",async function(){document.querySelectorAll(".books-box-itm").forEach(o=>{o.addEventListener("click",()=>{const t=o.id;console.log("Click"),S(t)})})});const f={default:3,largeScreen:5,smallScreen:1};function L(e){return e>=1440?f.largeScreen:e<768?f.smallScreen:f.default}const ke=window.innerWidth;let C=L(ke);window.addEventListener("resize",()=>{const e=window.innerWidth;C=L(e)});async function U(){const e=document.querySelector(".categories-list"),o=await ce();return e.innerHTML=o,e.addEventListener("click",fe),e}async function fe(e){e.preventDefault();const o=e.target;if(!o.closest(".categories-itm"))return;const s=o.dataset.categoryname,n=await U();$(n,s),s==="all categories"?P():await Z(n,s)}document.addEventListener("click",be);async function be(e){if(e.target&&e.target.classList.contains("books-btn-see-more")){const o=e.target.dataset.categoryname;await Z(null,o),window.scrollTo({top:0,behavior:"smooth"});const t=await U();$(t,o)}}async function Z(e,o){try{const t=document.querySelector(".books-box");if(!t){console.error("Element not found.");return}const s=await le(o);t.innerHTML=s}catch(t){console.error("Error displaying books by category:",t)}finally{}}async function P(){try{const e=document.querySelector(".books-box"),o=window.innerWidth;C=L(o);const s=await ae(C);e.innerHTML=s}catch(e){console.error("Error displaying top books:",e)}finally{}}window.addEventListener("load",()=>{P(),U()});function $(e,o){e.querySelectorAll(".categories-itm").forEach(s=>{s.firstElementChild.dataset.categoryname===o?s.classList.add("js-categories-current"):s.classList.remove("js-categories-current")})}document.addEventListener("click",function(e){if(e.target.classList.contains("books-overlay-text")){const o=e.target.dataset.id;console.log("Click"),S(o)}});document.addEventListener("DOMContentLoaded",async function(){const e=()=>{document.querySelectorAll(".books-box-itm").forEach(t=>{t.addEventListener("click",()=>{const s=t.id;console.log("Click"),S(s)})})};document.readyState==="complete"||document.readyState==="interactive"?e():document.addEventListener("DOMContentLoaded",e)});const x=document.querySelector(".support.container-s");x||console.error("Parent container not found.");let Y=0;const ye=[{title:"Save the Children",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img:"../img/support/save-the-children@2x.png"},{title:"Project HOPE",url:"https://www.projecthope.org/country/ukraine/",img:"../img/support/project-hope@2x.png"},{title:"UNITED24",url:"https://u24.gov.ua/uk",img:"../img/support/united24@2x.png"},{title:"International Medical Corps",url:"https://internationalmedicalcorps.org/country/ukraine/",img:"../img/support/international-medical-corps@2x.png"},{title:"Medicins Sans Frontieres",url:"https://www.msf.org/ukraine",img:"../img/support/medicins-sans-frontieres@2x.png"},{title:"RAZOM",url:"https://www.razomforukraine.org/",img:"../img/support/razom@2x.png"},{title:"Action against hunger",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img:"../img/support/action-against-hunger@2x.png"},{title:"World vision",url:"https://www.wvi.org/emergencies/ukraine",img:"../img/support/world-vision@2x.png"},{title:"Serhiy Prytula Charity Foundation",url:"https://prytulafoundation.org/en",img:"../img/support/serhiy-prytula-charity-foundation@2x.png"}],T=document.createElement("div");T.classList.add("swiper-container");const h=document.createElement("div");h.classList.add("swiper-wrapper");h.id="swiper-wrapper";function we(e){const o=document.createElement("div");o.classList.add("swiper-slide");const t=(Y+1).toString().padStart(2,"0"),s=document.createElement("a");s.classList.add("link-s"),s.href=e.url,s.target="_blank";const n=document.createElement("img");n.classList.add("img-s"),n.src=e.img,n.alt=e.title,s.appendChild(n);const i=document.createElement("span");i.classList.add("charity-index"),i.textContent=t,o.appendChild(i),o.appendChild(s),h.appendChild(o),Y++}ye.forEach(e=>{we(e)});T.appendChild(h);x.appendChild(T);const R=document.createElement("div");R.classList.add("button-con");const d=document.createElement("label");d.classList.add("container-btn");d.classList.add("btn-s");const c=document.createElement("input");c.setAttribute("type","checkbox");c.checked=!0;c.setAttribute("hidden",!0);const g=document.createElementNS("http://www.w3.org/2000/svg","svg");g.setAttribute("viewBox","0 0 512 512");g.setAttribute("height","1em");g.classList.add("chevron-down");g.innerHTML='<path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"></path>';d.appendChild(c);d.appendChild(g);R.appendChild(d);x.appendChild(R);c.addEventListener("change",()=>{const e=document.querySelector(".swiper-wrapper"),o=document.querySelector(".chevron-down");c.checked?o.style.transform="":o.style.transform="rotate(-180deg)",(e.scrollTop<=0?"down":"up")==="down"?e.scrollTop+e.clientHeight>=e.scrollHeight?e.scrollTop-=3*document.querySelector(".swiper-slide").offsetHeight:e.scrollTop+=3*document.querySelector(".swiper-slide").offsetHeight:e.scrollTop<=0?e.scrollTop+=3*document.querySelector(".swiper-slide").offsetHeight:e.scrollTop-=3*document.querySelector(".swiper-slide").offsetHeight});const Ce="/JavaScript_PG-5/assets/empy-books-tab-desk-1x-4e44a81a.png",ve="/JavaScript_PG-5/assets/empy-books-tab-desk-2x-33dfbeb3.png",Ee="/JavaScript_PG-5/assets/empty-books-mob-a43bd610.png",_=document.querySelector(".shopping-list-title");function a(){return JSON.parse(localStorage.getItem("addBook"))}function Se(e){te();const o=a().map(t=>`<li class="shoppinglist-book" id="${t._id}">
          <img
          ...
          /><div class="shoppinglist-cart-content">
            ...
            <button type="button" class="shoppinglist-book-deletebutton">
              <svg class="shoppinglist-btn-svg" width="18" height="18">
                <use href="${F}#icon-trash_bin"></use>
              </svg>
            </button>
          </div>
        </li>`).join("");_.insertAdjacentHTML("afterend",'<div class="shopinglist-cart"><ul class="shoppinglist-list"></ul></div>'),document.querySelector(".shoppinglist-list").innerHTML=o}function ee(){document.querySelector(".shoppinglist-list")&&document.querySelector(".shoppinglist-list").remove(),te();const e=`<p class="shopping-list-text">
    ...
    <img
      ...
      src="${Ee}"
      alt="a lot of books"
    />`;_.insertAdjacentHTML("afterend",e),O.info({message:"The list of books is empty.",timeout:3e3,position:"topRight"})}function te(){document.querySelector(".shopping-list-img")&&(document.querySelector(".shopping-list-img").remove(),document.querySelector(".shopping-list-text").remove())}document.querySelector(".shopping-list").addEventListener("click",e=>{if(e.target.nodeName=="BUTTON"){const o=e.target.closest("li").getAttribute("id"),t=a().filter(n=>n._id!==o);localStorage.setItem("addBook",JSON.stringify(t)),document.querySelector(`li[id="${o}"]`).remove()}(!a()||a().length===0)&&ee()});a()&&a().length>0?Se(a()):ee();window.addEventListener("load",()=>{setTimeout(()=>{},350)});document.querySelector(".loader");function Be(){window.scrollTo({top:0,behavior:"smooth"})}const p=document.querySelector(".top-btn");p.style.display="none";window.addEventListener("scroll",()=>{window.scrollY>window.innerHeight?p.style.display="inline-flex":p.style.display="none"});p.addEventListener("click",Be);
//# sourceMappingURL=main-06e28749.js.map
