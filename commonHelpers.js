import{i as q,a as m}from"./assets/vendor-8cce9181.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const w={openBurgerBtn:document.querySelector(".burger-menu"),closeBurgerBtn:document.querySelector(".mobile-menu__button"),burger:document.querySelector(".mobile-menu-container")};w.openBurgerBtn.addEventListener("click",A);w.closeBurgerBtn.addEventListener("click",A);function A(){w.burger.classList.toggle("is-hidden")}function g(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e),document.querySelectorAll('.common-toggle input[type="checkbox"]').forEach(function(t){e==="dark"?t.checked=!0:t.checked=!1})}const B=localStorage.getItem("theme");g(B||"light");const P=document.querySelectorAll('.common-toggle input[type="checkbox"]');P.forEach(function(e){e.addEventListener("change",function(o){o.target.checked?g("dark"):g("light")},!1)});const $=document.querySelector('.toggle-theme input[type="checkbox'),b=localStorage.getItem("theme");b&&(document.documentElement.setAttribute("data-theme",b),b==="dark"&&($.checked=!0));$.addEventListener("change",W,!1);function W(e){e.target.checked?(document.documentElement.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark")):(document.documentElement.setAttribute("data-theme","light"),localStorage.setItem("theme","light"))}function I(e){return e.map(t=>{const{_id:s,book_image:n,title:i,author:l}=t;return`<li class="books-box-itm" id="${s}">
      <div class="books-box-wrap">
            ...
            </li>`}).join("")}const U=(e,o)=>{if(!e||e.length===0){M("Sorry, books not found");return}else return`<h2 class="books-box-title">Best Sellers <span class="books-title-span"> Books</span></h2>${e.map(s=>{const n=s.list_name,i=I(s.books.slice(0,o));return`<div class="books-box-holder">
 ...
 <div class="books-category-box">
   <ul class="books-category-list">${t}</ul>
        ...
        </li>`).join("");j.insertAdjacentHTML("afterend",'<div class="shopinglist-cart"><ul class="shoppinglist-list"></ul></div>'),document.querySelector(".shoppinglist-list").innerHTML=o}function R(){document.querySelector(".shoppinglist-list")&&document.querySelector(".shoppinglist-list").remove(),z();const e=`<p class="shopping-list-text">
